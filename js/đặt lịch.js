...
document.addEventListener('DOMContentLoaded', () => {
     ...
     function showConsultations() {
          ...
          objectStore.openCursor().onsuccess = function(e) {
               ...
               if(cursor) {
                    ...
                    ConsultationHTML.innerHTML = `  
                         <p class="font-weight-bold">Tên Bệnh Nhân:  <span class="font-weight-normal">${cursor.value.patientname}<span></p>
                          <p class="font-weight-bold">Số Điện Thoại:  <span class="font-weight-normal">${cursor.value.contact}<span></p>
                         <p class="font-weight-bold">Ngày Hẹn:  <span class="font-weight-normal">${cursor.value.date}<span></p>
                         <p class="font-weight-bold">Giờ Hẹn:  <span class="font-weight-normal">${cursor.value.time}<span></p>
                         <p class="font-weight-bold">Ghi Chú:  <span class="font-weight-normal">${cursor.value.symptoms}<span></p>
          ...
          function redirect () {
               return window.location = "thankmail.html"
          }
          ...
          transaction.oncomplete = () => {
               ...
               if(!consultations.firstChild) {
                    ...
                    services.textContent = 'Đổi giờ thăm khám của bạn';
